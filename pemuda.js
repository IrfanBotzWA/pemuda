...
✓ Pemuda Teknologi  ( Recode 2 ) : 
https://youtube.com/c/CHANDRACHANNEL
✓ Irfan Botz ( Recode 3 )
https://youtube.com/channel/UCxRvln2-OC1tDCAEzjH0F3g
	...
	//•======>> SUBSCRIBE : PEMUDA TEKNOLOGI <<====•\\
        ...
        const sendWebp = async(from, url) => {
	        ...
	        pemuda.sendMessage(from, { disname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
				...
				const reply = (teks) => {
			pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6283110372378?text=Assalamualaikum%20Kakak%20Irfan%20yang%20Ganteng`}}})
		}
		const simir = (teks) => {
...
stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
 listMsg = {
 title : `Halo Tod ${pushname}〽️`,
 buttonText: '⎙ MENU DISNI',
 footerText: 'Wha The Pak Men🤙',
...
Silahkan pilih menu Kontol〽️`,
 ...
 rows: [
                          {
                              "title": "INFO",
                              "description" :"Klik Untuk Melihat Beberapa Informasi Botnya Kontol〽️",
                              "rowId": "infobot"
                          },
                          {
                              "title": "partnerbot",
...
menu = `⬣ 「 \`\`\`MENU OWNER\`\`\` 」
├────────────────────
│〽️${prefix}autorespon [ on/off ]
│〽️${prefix}bc [ teks/reply gif/image/video with caption ]
│〽️${prefix}tobc [ reply sticker/audio with caption ]
│〽️${prefix}return [ javascript ]
│〽️${prefix}clearall
│〽️${prefix}delchat
│〽️${prefix}mute
│〽️${prefix}unmute
│〽️${prefix}public
│〽️${prefix}self
│〽️${prefix}spam [ teks|jumlah ]
│〽️${prefix}demoteall
│〽️${prefix}promoteall
│〽️${prefix}addcmd [ teks reply stc ]
│〽️${prefix}delcmd [ reply stc ]
│〽️${prefix}listcmd
│〽️${prefix}spamsw [ teks|jumlah ]
│〽️${prefix}upswteks [ teks ]
│〽️${prefix}upswlokasi [ teks ]
│〽️${prefix}upswaudio [ reply audio ]
│〽️${prefix}upswvoice [ reply audio ]
│〽️${prefix}upswsticker [ reply sticker ]
│〽️${prefix}upswimage [ reply image with caption ]
│〽️${prefix}upswgif [ reply gif with caption ]
│〽️${prefix}upswvideo [ reply video with caption ]
│〽️${prefix}shutdown
│〽️${prefix}offline [ alasan ]
│〽️${prefix}online
│〽️${prefix}exif [ nama|author ]
│〽️${prefix}setprofile [ reply image ]
│〽️${prefix}setname [ teks ]
│〽️${prefix}setprefix [ multi/nopref ]
│〽️${prefix}setbio [ teks ]
│〽️${prefix}leave
│〽️${prefix}restart
│〽️${prefix}join [ link group ]
│〽️${prefix}addrespon [ tanya|jawab ]
│〽️${prefix}delrespon [ nama ]
│〽️${prefix}q [ reply message ]
│
├─⬣ WAR MENU
│〽️${prefix}virtex
│〽️${prefix}tovirgam [reply Sticker]
│〽️${prefix}bugkatalog
│〽️${prefix}bugloc
│〽️${prefix}bugrow
│〽️${prefix}buglink
│〽️${prefix}bugbutton
│〽️${prefix}bug [ jumlah ]
│〽️${prefix}bugpc2 [ jumlah ]
│〽️${prefix}bugtroli2 [ jumlah ]
│〽️${prefix}bugtroli3
│〽️${prefix}bugpc
│〽️${prefix}bugcombine
│〽️${prefix}bugtroli
...
│〽️${prefix}infogempa
│〽️${prefix}herolist
│〽️${prefix}herodetail [ hero ]
│〽️${prefix}google [ search ]
│〽️${prefix}gimage [ search ]
│〽️${prefix}wiki [ search ]
│〽️${prefix}mediafire [ link ]
│〽️${prefix}ytsearch [ judul ]
│〽️${prefix}ytmp4 [ link yt ]
│〽️${prefix}ytmp3 [ link yt ]
│〽️${prefix} [ judul lagu ]
│〽️${prefix}video [ judul video ]
│〽️${prefix}tinyurl [ link ]
│〽️${prefix}fetch [ link ]
│〽️${prefix}igdl [ link ]
│〽️${prefix}tiktokdl [ link ]
│〽️${prefix}pinterest [ search ]
│〽️${prefix}lirik [ judul ]
│〽️${prefix}tourl [ reply image/video ]
│〽️${prefix}resepmasakan [ judul ]
│〽️${prefix}artimimpi [ teks ]
│〽️${prefix}bilangangka [ angka ]
│〽️${prefix}kalkulator [ angka ]
│〽️${prefix}fancytext [ teks ]
│〽️${prefix}githubstalk [ username ]
│〽️${prefix}translate [ kodebhs|teks ]
│〽️${prefix}ss [ link ]
│〽️${prefix}tiktokaudio [ link ]
│〽️${prefix}igstory [ link ]
│〽️${prefix}linkwa
│〽️${prefix}store [ query ]
│〽️${prefix}fb [ link ]
└${prefix}twitter [ link ]`
katalog(menu)
break
...
menu = `⬣ 「 \`\`\`MENU MAKER\`\`\` 」
├────────────────────
│〽️${prefix}foliokiri 「 text 」
│〽️${prefix}foliokanan 「 text 」
│〽️${prefix}nulis 「 text 」
│〽️${prefix}nuliskanan 「 text 」
│〽️${prefix}nuliskiri 「 text 」
│〽️${prefix}tahta 「 text 」
│〽️${prefix}gold 「 text 」
│〽️${prefix}silver 「 text 」
│〽️${prefix}matrix [ teks ]
│〽️${prefix}googletxt [ teks ]
│〽️${prefix}spiderman [ teks ]
│〽️${prefix}express [ teks ]
│〽️${prefix}dance [ teks ]
│〽️${prefix}blackbird [ teks ]
│〽️${prefix}halloween [ teks ]
│〽️${prefix}vampire [ teks ]
│〽️${prefix}codetxt [ teks ]
│〽️${prefix}text3d [ teks ]
│〽️${prefix}warrior [ teks ]
│〽️${prefix}maker2d2 「 text 」
│〽️${prefix}maker2d3 「 text 」
│〽️${prefix}maker2d4 「 text 」
│〽️${prefix}maker3d 「 text 」
│〽️${prefix}maker3d2 「 text 」
│〽️${prefix}maker3d3 「 text 」
│〽️${prefix}maker3d4 「 text 」
│〽️${prefix}transformer 「 text 」
│〽️${prefix}googletxt 「 text 」
│〽️${prefix}battlefield 「 text 」
│〽️${prefix}coffeecup 「 text 」
│〽️${prefix}coffeecup2 「 text 」
│〽️${prefix}neon 「 text 」
│〽️${prefix}glow 「 text 」
│〽️${prefix}summer 「 text 」
│〽️${prefix}flower 「 text 」
│〽️${prefix}burn 「 text 」
│〽️${prefix}quote 「 text 」
│〽️${prefix}wooden 「 text 」
└${prefix}golden 「 text 」 `
katalog(menu)
break
case 'groupmenu':
menu = `⬣ 「 \`\`\`MENU GROUP\`\`\` 」
├────────────────────
│〽️${prefix}getpict [ @tag ]
│〽️${prefix}getname [ reply target ]
│〽️${prefix}getbio [ reply target ]
│〽️${prefix}promote [ @tag ]
│〽️${prefix}demote [ @tag ]
│〽️${prefix}antilink [ 1/0 ]
│〽️${prefix}nsfw [ 1/0 ]
│〽️${prefix}creategrup [ nama|@tag ]
│〽️${prefix}tictactoe [ @tag ]
│〽️${prefix}delttt
│〽️${prefix}getpp
│〽️${prefix}kick [ @tag ]
│〽️${prefix}add [ nomor ]
│〽️${prefix}kik [ Reply Pesan Target ]
│〽️${prefix}ad [ Reply Pesan Target ]
│〽️${prefix}getdeskgc
│〽️${prefix}sider [ reply pesan bot ]
│〽️${prefix}hacked [ teks ]
│〽️${prefix}setnamegc [ teks ]
│〽️${prefix}setdeskgc [ teks ]
│〽️${prefix}fitnah [ @tag|teks1|teks2 ]
│〽️${prefix}kontak [ @tag|nama ]
│〽️${prefix}kontag [ @tag|nama ]
│〽️${prefix}opengc
│〽️${prefix}closegc
...
│〽️${prefix}listonline
│〽️${prefix}listadmin
│〽️${prefix}hidetag [ teks ]
│〽️${prefix}sticktag [ nama sticker ]
...
│〽️${prefix}poke
│〽️${prefix}slap
│〽️${prefix}komiku [ query ]
│〽️${prefix}otaku [ query ]
└${prefix}chara [ query ]`
katalog(menu)
break
case 'othermenu':
...
├────────────────────
│〽️${prefix}getscmd
│〽️${prefix}stickerwm [ nama|author ]
│〽️${prefix}takestick [ nama|author ]
│〽️${prefix}colong [ reply sticker ]
│〽️${prefix}sticker
│〽️${prefix}semoji [ emoji ]
│〽️${prefix}attp [ teks ]
│〽️${prefix}toimg
│〽️${prefix}tomp3 [ reply video ]
│〽️${prefix}tomp4 [ reply sticker gif ]
│〽️${prefix}robot [ reply audio ]
│〽️${prefix}balik [ reply audio ]
│〽️${prefix}bass [ reply audio ]
│〽️${prefix}gemuk [ reply audio ]
│〽️${prefix}detikvn [ reply audio caption angka ]
│〽️${prefix}detikvideo [ reply video caption angka ]
│〽️${prefix}tts [ kodebhs teks ]
│
├─⬣ STORAGE
│〽️${prefix}addsticker [ nama ]
│〽️${prefix}delsticker [ nama ]
│〽️${prefix}addvn [ nama ]
│〽️${prefix}delvn [ nama ]
│〽️${prefix}addimage [ nama ]
│〽️${prefix}delimage [ nama ]
│〽️${prefix}listimage
...
│
├─⬣ OTHER / FUN
│〽️${prefix}caripesan [ teks|jumlah ]
│〽️${prefix}slots
│〽️${prefix}suit [ gunting/batu/kertas ]
│〽️${prefix}tag [ nomor ]
│〽️${prefix}tagme
│〽️${prefix}readmore [ teks1|teks2 ]
│〽️${prefix}fitnahpc [ nomor|teks1|teks2 ]
│〽️${prefix}chat [ nomor|teks ]
│〽️${prefix}fdeface [ replyimg link|teks1|teks2 ]
│〽️${prefix}listgrup
│〽️${prefix}baileys [ reply message ]
│〽️${prefix}getcaption [ reply message ]
│〽️${prefix}pantun
│〽️${prefix}tospam [ reply audio/sticker/image|jumlah ]
│〽️${prefix}sharelock [ teks1|teks2 ]
└${prefix}dadu`
katalog(menu)
break
///============ BASIC BUTTON ========\\\\
...
case 'sewa':
       ...
       menu = `0`
sendButLocation(from, `*_Halo Tod ${pushname} 〽️_* \n\nyakin nih mau sewa bot ?  Boong auto Ilang Biji Kau〽️ >_<`, "*Pemuda Teknologi © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'🗿Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
...
bcteks = [{buttonId: `menu`, buttonText: {displayText: '⎙ MENU DISNI'}, type: 1},{buttonId: `owner`, buttonText: {displayText: 'PEMBUAT BOT'}, type: 1}]
const btnbc = {
...
break
case 'qrcode':
if (!c) return reply('Textnya mana Kontol? contoh .qrcode Pemuda')
reply(mess.wait)
...
break
case 'tahta': 
if (args.length < 1) return reply('*Teks Nya Mana Kontol*') 
tahta = args.join(" ")
reply(mess.wait)
...
break 
case 'nuliskiri':
if (!c) return reply('*Textnya Mana Kontol*')
reply(mess.wait)
...
case 'glow': 
       ...
       case 'quote': 
		...
		case 'wasted':
             ...
             reply('Gunakan foto/stiker Anjeng🗿')
             }
             break
//🐀💰 MALING
case 'trigger':
		...
		case 'gay':
             ...
             s11 = c.split('|')[0]
             s12 = c.split('|')[1] 
             if(!s12)return reply('Text2 Nya Pake Kontol..')
             if (mek.message.extendedTextMessage != undefined || mek.message.extendedTextMessage != null) {
             ger = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
             reply(mess.wait)
             owgi = await pemuda.downloadMediaMessage(ger)
...
break
			...
			case 'golden': 
					...
					break
               case 'fancytext':
				if (args.length < 1) return reply('Teksnya Mana Kontol〽️')
...
•🔗 Link Channel : ${yut.all[0].author.url}`
             ...
             contentText: capti,
             footerText: 'Silahkan Pilih Jenis File Dibawah Ini〽️',
             buttons: gbutsan,
             headerType: 4
}
      ...
      case 'buttonmusic':
             //if (!isRegister) return reply(mess.only.regis)      	     
             if(!c) return reply('Linknya Mana Kontol〽️')              
...
case 'ttt':
if (!isGroup) return reply(mess.only.group)
if (args.length < 1) return reply('Tag Lawan Anda Anjeng🗿 ')
if (isTTT) return reply('Sedang Ada Permainan Di Grub Ini, Harap Tunggu Ngentot🗿')
...
break
                ...
                case 'delttc':
if (!isGroup) return reply(mess.only.group)
if (!isTTT) return reply('Tidak Ada Permainan Di Grub Ini Ngentot🗿')
...
case 'pinterest':
if (!c) return reply('Yang Mau Di Cari Apa Kontol〽️')
reply(mess.wait)
...
break
case 'lirik':
if (args.length < 1) return reply('Judulnya Mana Anjeng🗿')
reply(mess.wait)
teks = body.slice(7)
...
case 'gimage':
case 'googleimage':
if (args.length < 1) return reply('Apa Yang Mau Dicari Ngentot🗿')
reply(mess.wait)
teks = args.join(' ')
...
case 'googlesearch':
case 'ggs':
if (args.length < 1) return reply('Yang Mau Di Cari Apa Kontol〽️')
teks = args.join(' ')
reply(mess.wait)
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉\n\n`
            ...
            break
case 'ytsearch':
                     if (!args.length) return reply('Judulnya Apa Kontol')
                     try {
                        reply(mess.wait)
...
case 'bugtroli2':
if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
if (args.length < 1) return reply('Jumlahnya Berapa Anjeng🗿')
		        try {
		        var hets = `${NamaBot}`
...
case 'addsticker':
				if (!isOwner && !mek.key.fromMe) return reply(mess.only.ownerB)
					...
					nm = body.slice(12)
					if (!nm) return reply('Nama Sticker Nya Apa Anjeng🗿')
				...
				case 'liststicker':
					...
					nm = body.slice(7)
					if (!nm) return reply('Nama Vn Nya Apa Anjeng 🗿')
					boij = JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo
					delb = await pemuda.downloadMediaMessage(boij)
					vien.push(`${nm}`)
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from,  `${menu}`, `${uwu}Wha The Pak Men🤙 ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🔥'},type:1}, {buttonId:`${prefix}ofc`,buttonText:{displayText:'GRUP OFFICIAL👥'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
...
• https://youtube.com/UCxRvln2-OC1tDCAEzjH0F3g
...
const kontil = body.slice(8)
                    ...
                    pemuda.sendMessage('6283110372378@s.whatsapp.net', options, text, {quoted: mek})
...
break
		case 'instainfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Instagram Pemilik Bot, Jangan Lupa Follow yak😉\n\nhttps://instagram.com/irfansaputra8525", matchedText: 'https://instagram.com/irfansaputra8525', description: "", title: "KLIK UNTUK FOLLOW", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'youtubeinfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Youtube Pemilik Bot, Jangan Lupa Subcribe yak😉\n\nhttps://youtube.com/UCxRvln2-OC1tDCAEzjH0F3g", matchedText: 'https://youtube.com/UCxRvln2-OC1tDCAEzjH0F3g', description: "", title: "KLIK UNTUK SUBCRIBE", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		
case 'partnerbot':
		pemuda.sendMessage(from, { text: "*Partner Bot Farhan*\n\n- Bot Irfan :\nhttps://wa.me/6281389140644?text=.menu\nThanks Udah Makek Bot ini😉", matchedText: 'https://youtu.be/x-O0WHkv3uc', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'speed':
               case 'ping':
...
nuber = parseInt(budy)
if (isNaN(nuber)) return
if (nuber < 1 || nuber > 9) return reply('Masukan Angka Yang Benar Njeng🗿')
main = ky_ttt.filter(hjh => hjh.id.includes(from)) 
if (!tttawal.includes(main[0].angka[nuber])) return reply('Udah Di Isi, Isi Yang Lain Kontol')
if (main[0].gilir.includes(sender)) return reply('Tunggu Giliran Anjeng🗿')
s = '⭕'
main[0].angka[nuber] = s
